...
public class Main extends GLCanvas implements GLEventListener, KeyListener,
    ...
    public void display( GLAutoDrawable drawable ) {
        ...
        sleepTime = ((1000000000/FPS) - (endTime - startTime)) / 1000000;
    ...
    private static void initEnemies() {
        enemies.add( new Enemy( 7, 2, 50) );
        enemies.add( new Enemy( -4, 10, 120) );
        enemies.add( new Enemy( -2, -5, 30) );
        enemies.add( new Enemy( 6, -7, 45) );
    }
